...
contract Web3Shop {
    ...
    function buyItem(uint256 _id, uint _timestamp) payable public {
        ...
        bytes32 _func = keccak256(abi.encodePacked(
            choosenItem.seller.call{ value: choosenItem.price }("New order")
        ));
    ...
    function confirm(bytes32 _txId, uint256 _id) external {
        ...
        require(msg.sender == choosenItem.seller 
                    ||
